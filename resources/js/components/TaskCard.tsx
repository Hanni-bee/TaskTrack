        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-4 text-sm text-slate-400">
            ...
            {task.reminder_at && (
              <div className="flex items-center gap-1">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 17h5l-5 5v-5zM4.868 12.683A17.925 17.925 0 0112 21c7.962 0 12-1.21 12-2.683m-12 2.683a17.925 17.925 0 01-7.132-8.317M12 21c4.411 0 8-4.03 8-9s-3.589-9-8-9-8 4.03-8 9a9.06 9.06 0 001.832 5.683L4 21l4.868-8.317z" />
                </svg>
                <span>Reminder: {formatDate(task.reminder_at)}</span>
              </div>
            )}
          ...
          {task.notes && (
            <div className="mt-4 p-3 bg-slate-700/30 rounded-lg border border-slate-600/30">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">{task.notes}</p>
            </div>
          )}
        </div>
